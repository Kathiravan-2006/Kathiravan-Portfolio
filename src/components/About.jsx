      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            {/* Quick Quote Widget */}
            <div className="glass-panel-light p-6 rounded-2xl border border-white/5 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${pillar.color} p-[1px] flex items-center justify-center mb-5 shadow-[0_0_15px_rgba(6,182,212,0.15)] group-hover:shadow-[0_0_20px_rgba(139,92,246,0.3)] transition-all duration-300`}>
                      <div className="w-full h-full bg-surface-dark rounded-xl flex items-center justify-center">
                        <Icon className="w-5 h-5 text-white group-hover:text-accent-cyan transition-colors duration-300" />
                      </div>
                    </div>
                    
                    <h4 className="font-heading font-bold text-base text-white mb-2 tracking-wide group-hover:text-accent-cyan transition-colors duration-300">
                      {pillar.title}
                    </h4>
