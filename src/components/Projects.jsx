      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {projectsData.map((project, idx) => (
            ...
            >
              <TiltCard className="glass-panel rounded-3xl overflow-hidden border border-white/8 h-full flex flex-col glow-card select-none group">
                {/* Project Image Panel */}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tech.map((t) => (
                        <span
                          key={t}
                          className="px-2.5 py-0.8 rounded-md bg-white/5 border border-white/5 text-text-secondary text-[10px] font-semibold tracking-wider uppercase transition-colors duration-300 hover:border-accent-cyan/20 hover:text-white"
                        >
                          {t}
                        </span>
                      ))}
                    ...
                    <h3 className="font-heading font-bold text-lg md:text-xl text-white mb-6 tracking-wide group-hover:text-accent-cyan transition-colors duration-300">
                      {project.title}
                    </h3>
                    ...
                    <div className="flex gap-3 mb-4">
                      ...
                      <div>
                        <h4 className="font-heading font-semibold text-xs text-white uppercase tracking-wider mb-1">
                          Problem
                        </h4>
                  ...
                  <div className="flex gap-4 pt-4 border-t border-white/5">
                    {project.githubUrl ? (
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-white/10 hover:border-accent-cyan/30 text-white font-medium text-xs transition-all duration-300 hover:bg-white/5 cursor-none clickable"
                      >
                        <FiGithub className="w-4 h-4 text-accent-cyan" />
                        Source Code
                      </a>
                    ) : (
                      <div className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-white/10 text-white font-medium text-xs opacity-80">
